...
@Component({
  selector: 'app-addmore-general',
  templateUrl: './addmore-general.component.html',
  styleUrls: ['./addmore-general.component.css']
})
export class AddmoreGeneralComponent implements OnInit {
