...
@Component({
  selector: 'app-view-revistion-addmore',
  templateUrl: './view-revistion-addmore.component.html',
  styleUrls: ['./view-revistion-addmore.component.css']
})
export class ViewRevistionAddmoreComponent implements OnInit {
