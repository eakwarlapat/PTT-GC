...
export class CapexComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.capexService.GetCapexsInfo(this.id.toString(), 'Createnew').subscribe(response => {
      ...
      sessionStorage.setItem('response.capexStatus', this.capexStatus.toString());
      sessionStorage.setItem('capexType', this.capexType.toString());
  ...
  CheckValidate() {
    console.log(sessionStorage.getItem('InitiativeValidate'));
  ...
  GetInitiative() {
    ...
    this.capexService.GetCapexsInformationBySubmit(this.id).subscribe(response => {
      ...
      for (let i = 0; i <= response.length; i++) {
        ...
        this.Revistion = response[i].revistion;
        console.log("Revistion : ", this.Revistion);
  ...
  Savedraf() {
    ...
    console.log("Check Capex Id. : ", this.id);
    this.capexService.GetCapexsInfo(this.id.toString(), 'Createnew').subscribe(resp_1 => {

      console.log("Check Capex Type. : ", resp_1);

      this.capexType = resp_1.capexType;
      this.capexId = '';

    if(resp_1 != null || resp_1 != undefined ){

      this.capexId = resp_1.capexInformationId;
    ...
    if ( this.capexType == 'Createnew') {
      ...
      this.capexService.PutUpdateCapexsinformations(
        ...
        console.log("Success Capex Update : ", responseUpdate);
      });
      ...
      this.capexService.CreateCapexsInfo(
        ...
        console.log("Response SAVE Draft Capex info");
        ...
        this.capexService.GetCapexsInfo(this.id.toString(), 'Createnew').subscribe(resp_1 => {
          ...
          this.router.navigate(['/initiative/capex/:id']);
    ...
    if (tmp_error != "yes" && this.flag_fail != "yes") {
      ...
      this.capexService.CreateCapexsInfo(
        ...
        this.capexService.GetCapexsInfo(this.id.toString(), 'Createnew').subscribe(resp_1 => {
          ...
          console.log("Check Capex Type. : ", resp_1.capexType);

          if (resp_1.capexType == 'Createnew') {
